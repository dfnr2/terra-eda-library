-- db/tables/cern_stelvio_kontek_comatel/cern_stelvio_kontek_comatel_0_schema.sql
-- Terra EDA Library - cern_stelvio_kontek_comatel table schema (CERN 'STELVIO-KONTEK COMATEL' connectors).
...
CREATE TABLE cern_stelvio_kontek_comatel (
