# cern_stelvio_kontek_comatel — Human Audit

Source: CERN `STELVIO-KONTEK COMATEL` connectors (106 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_stelvio_kontek_comatel-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_stelvio_kontek_comatel-*) render in KiCad.
