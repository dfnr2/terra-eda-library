...
PARTS = [
    {
        ...
        "kicad_symbol": "terra_symbols_mosfet:IC_SSR Infineon BTS5030-1EJA MOSFET high-side switch 30 mOhm 5A 28V DSO-8",
    ...
    },
    {
        ...
        "kicad_symbol": "terra_symbols_mosfet:MOSFET DMP3099L P-channel 30V 3.8A",
        ...
        "transistor_type": "pmos", "channels": 1,
        "power_dissipation": "1.08W (Ta=25C)",
        "rds_on": "65mOhm max @ Vgs=-10V, Id=-3.8A (99mOhm max @ Vgs=-4.5V, Id=-3.0A)",
        "vgs_th": "-1.0V min / -2.1V max",
        "temp_junction_max": "150C",
    },
    {
        ...
        "kicad_symbol": "terra_symbols_mosfet:MOSFET Infineon IRLM2502 N-channel 4.2A 20V",
        "kicad_footprint": "Package_TO_SOT_SMD:SOT-23",
        "rohs": "Yes", "rohs_document_link": IHS_INFN,
        "allow_substitution": "Yes", "tracking": "No", "standards_version": "1.1",
        "source": "terra_sym", "dump_priority": 0, "tier": 2, "pin_count": "3",
