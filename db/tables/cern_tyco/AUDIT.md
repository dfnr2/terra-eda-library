# cern_tyco — Human Audit

Source: CERN `TYCO` connectors (467 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_tyco-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_tyco-*) render in KiCad.
