# cern_fci — Human Audit

Source: CERN `FCI` connectors (83 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_fci-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_fci-*) render in KiCad.
