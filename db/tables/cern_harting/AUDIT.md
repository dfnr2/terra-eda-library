# cern_harting — Human Audit

Source: CERN `HARTING` connectors (323 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_harting-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_harting-*) render in KiCad.
