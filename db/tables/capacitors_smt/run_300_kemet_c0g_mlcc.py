...
""",
    ...
    "insert": """INSERT INTO capacitors_smt (unique_id, part_locator, mpn, manufacturer, package, value, description, datasheet, manufacturer_link, kicad_symbol, kicad_footprint, source, dump_priority, tier, tags, voltage_rating_v, tolerance, cap_type, dielectric_class, polarized, temp_operating_min, temp_operating_max, temp_storage_min, temp_storage_max, temp_soldering, lifecycle_status, rohs, rohs_document_link, allow_substitution, tracking, created_at, updated_at, created_by, height_max_mm)
VALUES ('{unique_id}', '{part_locator}', '{mpn}', '{manufacturer}', '{package}', '{value_spice}', '{description}', '{datasheet}', '{manufacturer_link}', '{kicad_symbol}', '{kicad_footprint}', {source}, {dump_priority}, {tier}, '{tags}', {voltage_rating}, '{tolerance}', '{cap_type}', '{dielectric_class}', '{polarized}', {temp_operating_min}, {temp_operating_max}, {temp_storage_min}, {temp_storage_max}, {temp_soldering}, '{lifecycle_status}', '{rohs}', '{rohs_link}', '{allow_substitution}', '{tracking}', '{created_at}', '{updated_at}', '{created_by}', {height_max_mm});""",
