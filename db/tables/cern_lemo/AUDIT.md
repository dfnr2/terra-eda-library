# cern_lemo — Human Audit

Source: CERN `LEMO` connectors (90 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_lemo-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_lemo-*) render in KiCad.
