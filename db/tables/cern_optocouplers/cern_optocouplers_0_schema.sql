-- db/tables/cern_optocouplers/cern_optocouplers_0_schema.sql
-- Terra EDA Library - cern_optocouplers table schema (CERN 'Optocouplers').
-- Core fields match the go-forward core; tier defaults to 5 per TIER_TAG_SPEC.org.

CREATE TABLE cern_optocouplers (
