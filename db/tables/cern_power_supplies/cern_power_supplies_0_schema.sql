-- db/tables/cern_power_supplies/cern_power_supplies_0_schema.sql
-- Terra EDA Library - cern_power_supplies table schema (CERN 'Power Supplies').
-- Core fields match the go-forward core; tier defaults to 5 per TIER_TAG_SPEC.org.
-- A grab-bag of vendor AC-DC / DC-DC power bricks (TRACO, XP POWER, MEAN WELL,
-- ISEG, HAMAMATSU, …) with module-named symbols/footprints, uniformly 'Standard'
-- Component Type and a blank Case, so no type-specific tail.

CREATE TABLE cern_power_supplies (
