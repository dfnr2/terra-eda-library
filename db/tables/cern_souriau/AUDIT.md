# cern_souriau — Human Audit

Source: CERN `SOURIAU` connectors (97 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_souriau-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_souriau-*) render in KiCad.
