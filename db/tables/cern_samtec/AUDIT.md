# cern_samtec — Human Audit

Source: CERN `SAMTEC` connectors (1363 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_samtec-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_samtec-*) render in KiCad.
