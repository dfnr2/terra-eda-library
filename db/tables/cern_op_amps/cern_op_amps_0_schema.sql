-- db/tables/cern_op_amps/cern_op_amps_0_schema.sql
-- Terra EDA Library - cern_op_amps table schema (CERN 'Operational Amplifiers').
-- Core fields match the go-forward core; tier defaults to 5 per TIER_TAG_SPEC.org.

CREATE TABLE cern_op_amps (
