-- db/tables/cern_regulators/cern_regulators_0_schema.sql
-- Terra EDA Library - cern_regulators table schema (CERN import).
-- Core fields match the go-forward core; tier defaults to 5 per TIER_TAG_SPEC.org.

CREATE TABLE cern_regulators (
