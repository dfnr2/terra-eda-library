# cern_weidmuller — Human Audit

Source: CERN `WEIDMULLER` connectors (62 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_weidmuller-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_weidmuller-*) render in KiCad.
