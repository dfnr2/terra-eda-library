# cern_amphenol — Human Audit

Source: CERN `AMPHENOL` connectors (194 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_amphenol-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_amphenol-*) render in KiCad.
