...
Source: CERN `3M` connectors (359 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_3m-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_3m-*) render in KiCad.
