-- db/tables/cern_logic/cern_logic_0_schema.sql
-- Terra EDA Library - cern_logic table schema (CERN 'Logic').
...
-- serdes, …) with device-named symbols, so it carries no type-specific tail.

CREATE TABLE cern_logic (
