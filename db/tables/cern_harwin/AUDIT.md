# cern_harwin — Human Audit

Source: CERN `HARWIN` connectors (145 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_harwin-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_harwin-*) render in KiCad.
