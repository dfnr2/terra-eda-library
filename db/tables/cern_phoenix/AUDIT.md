# cern_phoenix — Human Audit

Source: CERN `PHOENIX` connectors (347 parts). Generated via `tools/cern_import.generate`.

## Automated
- [ ] `make cern_phoenix-build` green; covered by `tests/test_cern_connectors.py` (row count,
...
- [ ] `kicad_symbol` (cern-connectors) and `kicad_footprint` (cern-cern_phoenix-*) render in KiCad.
