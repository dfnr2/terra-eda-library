-- db/tables/cern_transistors/cern_transistors_0_schema.sql
-- Terra EDA Library - cern_transistors table schema (CERN import).
-- Core fields match the go-forward core; tier defaults to 5 per TIER_TAG_SPEC.org.

CREATE TABLE cern_transistors (
