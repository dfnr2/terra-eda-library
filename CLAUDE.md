...
-- Electrical Rating
current_rating_a        REAL,    -- per contact continuous rating (A)
voltage_rating_v        REAL,    -- working voltage rating (V)
...
mounting_type           TEXT,    -- 'tht', 'smt', 'panel', 'cable', 'edge'
